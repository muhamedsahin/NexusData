...
#
get_filename_component(filename "C:/Users/muham/Desktop/Nexus/lib/NexusData/build-arrow/_deps/nd_zstd-subbuild/nd_zstd-populate-prefix/src/zstd-1.5.7.tar.gz" ABSOLUTE)
get_filename_component(directory "C:/Users/muham/Desktop/Nexus/lib/NexusData/build-arrow/_deps/nd_zstd-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-nd_zstd-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-nd_zstd-populate${i}")
