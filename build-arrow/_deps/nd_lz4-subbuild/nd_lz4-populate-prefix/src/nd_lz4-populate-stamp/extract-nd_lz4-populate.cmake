...
#
get_filename_component(filename "C:/Users/muham/Desktop/Nexus/lib/NexusData/build-arrow/_deps/nd_lz4-subbuild/nd_lz4-populate-prefix/src/lz4-1.10.0.tar.gz" ABSOLUTE)
get_filename_component(directory "C:/Users/muham/Desktop/Nexus/lib/NexusData/build-arrow/_deps/nd_lz4-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-nd_lz4-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-nd_lz4-populate${i}")
