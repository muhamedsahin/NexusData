...
#
get_filename_component(filename "C:/Users/muham/Desktop/Nexus/lib/NexusData/build-arrow/_deps/nd_zlib-subbuild/nd_zlib-populate-prefix/src/zlib-1.3.1.tar.gz" ABSOLUTE)
get_filename_component(directory "C:/Users/muham/Desktop/Nexus/lib/NexusData/build-arrow/_deps/nd_zlib-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-nd_zlib-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-nd_zlib-populate${i}")
