...
#
get_filename_component(filename "C:/Users/muham/Desktop/Nexus/lib/NexusData/build-arrow/_deps/nd_bzip2-subbuild/nd_bzip2-populate-prefix/src/bzip2-1.0.8.tar.gz" ABSOLUTE)
get_filename_component(directory "C:/Users/muham/Desktop/Nexus/lib/NexusData/build-arrow/_deps/nd_bzip2-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-nd_bzip2-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-nd_bzip2-populate${i}")
